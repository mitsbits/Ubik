...
namespace Ubik.Web.SSO
{
    ...
    public class UbikUser : IdentityUser<int>
    {
        ...
        /// The Id property is initialized to from a new GUID string value.
        /// </remarks>
        public UbikUser(string userName) : base(userName)
        {
            Id = default(int);
        }
        ...
        /// </summary>
        public virtual ICollection<UbikUserClaim> Claims { get; } = new List<UbikUserClaim>();

        /// <summary>
        /// Navigation property for this users login accounts.
        /// </summary>
        public virtual ICollection<UbikUserLogin> Logins { get; } = new List<UbikUserLogin>();

        /// <summary>
        /// Navigation property for the roles this user belongs to.
        /// </summary>
        public virtual ICollection<UbikUserRole> Roles { get; } = new List<UbikUserRole>();
    }
